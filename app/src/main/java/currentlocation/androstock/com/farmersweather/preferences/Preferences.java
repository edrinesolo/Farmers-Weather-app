package currentlocation.androstock.com.farmersweather.preferences;
 ...
 *
 * @deprecated use {@link currentlocation.androstock.com.farmersweather.preferences.Prefs} class instead.
 */
@Deprecated
public class Preferences {
    ...
    public String getCity() {
        return prefs.getString("city", "Mbarara");
    }
    ...
    public String getLastCity() {
        return prefs.getString("lcity" , "Mbarara");
    }
}